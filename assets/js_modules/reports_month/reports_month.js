...
$(document).ready(function() {
	...
	$('#btnSave').click(function() {
		$('#addModal').modal('hide');
		Reports_month.saveFormData();
		return false;
	});//click

	$('#btnSaveEdit').click(function() {
		return Reports_month.validateFormEdit();
	});//click
	$('#btnSaveEditMember').click(function() {
		return Reports_month.validateFormEditMember();
	});//click
	...
	if(typeof param_current_page != 'undefined'){
		Reports_month.current_page = Math.abs(param_current_page);
	}
	...
	$(document).on('click','.btn-delete-row', function(){
		...
		Reports_month.confirmDelete(pProductId,  row_num);
	});//click

	$(document).on('click','#btn_confirm_delete', function(){
		Reports_month.deleteRecord();
	});
