...
$(document).ready(function() {
	...
	$('#btnSave').click(function() {
		$('#addModal').modal('hide');
		Reports_seller.saveFormData();
		return false;
	});//click

	$('#btnSaveEdit').click(function() {
		return Reports_seller.validateFormEdit();
	});//click
	$('#btnSaveEditMember').click(function() {
		return Reports_seller.validateFormEditMember();
	});//click
	...
	if(typeof param_current_page != 'undefined'){
		Reports_seller.current_page = Math.abs(param_current_page);
	}
	...
	$(document).on('click','.btn-delete-row', function(){
		...
		Reports_seller.confirmDelete(pProductId,  row_num);
	});//click

	$(document).on('click','#btn_confirm_delete', function(){
		Reports_seller.deleteRecord();
	});
