...
$(document).ready(function() {
	...
	$('#btnSave').click(function() {
		$('#addModal').modal('hide');
		Reports.saveFormData();
		return false;
	});//click

	$('#btnSaveEdit').click(function() {
		return Reports.validateFormEdit();
	});//click
	$('#btnSaveEditMember').click(function() {
		return Reports.validateFormEditMember();
	});//click
	...
	if(typeof param_current_page != 'undefined'){
		Reports.current_page = Math.abs(param_current_page);
	}
	...
	$(document).on('click','.btn-delete-row', function(){
		...
		Reports.confirmDelete(pProductId,  row_num);
	});//click
